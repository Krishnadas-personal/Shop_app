              ...
              child: Column(
                ...
                children: <Widget>[
                  Flexible(
                    ...
                    transform: Matrix4.rotationZ(12 * pi / 150)
                      ..translate(12.0),
                    // ..translate(-10.0),
                    decoration: BoxDecoration(
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (error.toString().contains('EMAIL_EXISTS')) {
        ...
        errorMessage =
            'This email address is invaild, Please try with a valid email address';
      } else if (error.toString().contains('WEAK_PASSWORD')) {
        errorMessage = 'This password is too weak';
      } else if (error.toString().contains('INVALID_PASSWORD')) {
        errorMessage = 'Invaild Password';
      } else if (error.toString().contains('EMAIL_NOT_FOUND')) {
        errorMessage = 'Email address is not registered, Please Sign Up';
      }
      showDialogBox(context, errorMessage);
    } catch (error) {
